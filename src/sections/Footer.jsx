...
const Footer = () => {
  return (
    <footer className="max-container">
      <div className="flex justify-between items-start flex-wrap gap-20 max-lg:flex-col">
        <div className="flex flex-col items-start">
          <a href="/">
            ...
            <h1 className="text-2xl text-white-400">Logo Here</h1>
          </a>
          <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">
            Get shoes ready for a new term at your nearest nike store.
          </p>
      ...
      <div className="flex justify-between text-white-400 mt-24 mx-sm:flex-col max-sm:items-center">
